...
using Vinva.Gastronomy.Identity.Application.Authentication.RefreshJwtToken;
...
namespace Vinva.Gastronomy.Identity.Application.Authentication.Register
{
    public class RegisterHandler : IRequestHandler<RegisterRequest, Result>
    {
        ...
        private readonly RegisterHandlerConfig _registerConfig;

        public RegisterHandler(IIdentityUnitOfWork identityUnitOfWork,
            IRegistrationService registrationService,
            IOptions<RegisterHandlerConfig> emailConfig,
